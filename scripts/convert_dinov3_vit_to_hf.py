...
def prepare_img():
    ...
    data_path = "/localfolder/code/LLaMA-Factory/tests/images/000000039769.jpg"
...
def convert_and_test_dinov3_checkpoint(args):
    ...
    print("Start process the state dict and convert to hf model...")
    ...
    print("Load the converted state dict and test the forward pass...")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-path",
        default="/localfolder/data/dinov3/dinov3_vitl16_pretrain_lvd1689m-8aa4cbdd.pth",
        type=str,
        help="Path to the model checkpoint.",
    )
    parser.add_argument(
        "--save-dir",
        default="/localfolder/data/dinov3/hf_models",
        type=str,
